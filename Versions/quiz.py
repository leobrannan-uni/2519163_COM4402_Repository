# The function 'sleep' used to give delays inbetween information.
...
""" Function 'question' is simply used to print out the question and the multiple choice answers, 
    ...
    answer and correct answer can be collected and used for the program. """
def question(df, i):
    print("\n#####################\n")
...
""" Function 'choice_range' then gets the user to input their answer and verifies if it's in the 
    ...
    if it can check if the input is in the range. If it's not in the range or not an integer,
