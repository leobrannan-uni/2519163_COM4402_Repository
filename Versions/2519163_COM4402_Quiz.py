...
def quiz(questions, answers, correct_answers, name):
    ...
    while i < 5:
        ...
        print(answers[i])
        choice = input("\nAnswer: ")
        choice = int_range(choice, correct_answers, i)
...
def int_range(choice, correct_answers, i):
    try:
        choice = int(choice)
        if 0 < choice < 4:
            return int(choice)
...
def data(name):
    questions = ("What German became the recent England football manager?",
                 ...
                 "The bestselling book 'Glucose Revolution' is subtitled 'the Life-changing Power of "
                 "Balancing Your Blood' what?", "Meerkat Movies is a promotion by what comparison website?")
    answers = ("1. Thomas Tuchel. 2. Thomas Frank. 3. Thomas Muller.", "1. Mint. 2. Gravy. 3. Cranberry.",
               "1. Car. 2. Sleigh. 3. Bicycle.", "1. Pressure. 2. Alcohol Content. 3. Sugar.",
